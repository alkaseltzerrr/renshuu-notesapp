import { Plus, Trash2, Edit3, Save, X, Pin, Tag } from 'lucide-react';
import { useState } from 'react';
import SearchAndFilter from './SearchAndFilter';
import MarkdownRenderer from './MarkdownRenderer';

function NotesList({ notes, input, setInput, loading, addNote, deleteNote, updateNote }) {
    ...
    <>
      ...
      <form className="notes-form" onSubmit={handleAddNote}>
        <textarea
          ...
          placeholder="Type your note here... Use **bold**, *italic*, [link](url), - list items"
          disabled={loading}
      ...
      <div className="notes-list">
        ...
        {sortedNotes.length === 0 && !loading && <p className="no-notes">No notes found.</p>}
      </div>
    </>
  );
}
